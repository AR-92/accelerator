  ...
  plugins: {
    ...
    '@fullhuman/postcss-purgecss': {
      ...
      safelist: [
        ...
        {
          pattern: /^(bg|text|border|ring)-(primary|secondary|accent|destructive|muted|card|popover|foreground|background|sidebar)/,
          variants: ['hover', 'focus', 'active', 'dark', 'group-hover', 'group-focus']
        },
