...
const userMessagePath = path.join(
  __dirname,
  '../views/main/partials/components/_user-message.hbs'
);
...
if (fs.existsSync(ideaCardPath)) {
  ...
  const portfolioCardPath = path.join(
    __dirname,
    '../views/main/partials/components/_portfolio-card.hbs'
  );
...
const ideaRatingWidgetPath = path.join(
  __dirname,
  '../views/main/partials/components/_idea-rating-widget.hbs'
);
...
const buildStartUpPath = path.join(
  __dirname,
  '../views/main/partials/components/_build-start-up.hbs'
);
...
const portfolioListPath = path.join(
  __dirname,
  '../views/main/partials/components/_portfolio-list.hbs'
);
...
const businessModelPath = path.join(
  __dirname,
  '../views/main/partials/components/_business-model.hbs'
);
...
const marketingModelPath = path.join(
  __dirname,
  '../views/main/partials/components/_marketing-model.hbs'
);
...
const financialModelPath = path.join(
  __dirname,
  '../views/main/partials/components/_financial-model.hbs'
);
...
const legalModelPath = path.join(
  __dirname,
  '../views/main/partials/components/_legal-model.hbs'
);
