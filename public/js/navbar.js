console.log("hello i am navbar");
  ...
  (function () {
    ...
    function updateAllThemeToggles() {
      ...
      const darkIcon = document.querySelector('#navbar-theme-toggle .dark\\:block');
      const lightIcon = document.querySelector('#navbar-theme-toggle .dark\\:hidden');
    ...
    function initializeNavbarDropdowns() {
      ...
      const navbarUserProfileDropdown = document.getElementById('navbar-user-profile-dropdown');

      if (navbarUserProfileDropdown) {
        // Get the dropdown button and menu
        const dropdownButton = navbarUserProfileDropdown.querySelector('button[type="button"]');
        const dropdownMenu = navbarUserProfileDropdown.querySelector('div.absolute');
