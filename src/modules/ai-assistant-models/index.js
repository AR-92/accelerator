/**
 * AI Assistant Models Module
 * Handles AI assistant model pages
 */

const express = require('express');
const { optionalAuth } = require('../../middleware/auth/auth');

const createAiAssistantModelsModule = (container) => {
  ...
  // GET financial model
  router.get(
    '/ai-assistant-models/financial-model',
    optionalAuth,
    (req, res) => {
  ...
  // GET marketing model
  router.get(
    '/ai-assistant-models/marketing-model',
    optionalAuth,
    (req, res) => {
...
module.exports = createAiAssistantModelsModule;
