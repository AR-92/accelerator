...
} = require('../../../../shared/middleware/auth/adminAuth');
...
router.get('/profile', requireAdminAuth, (req, res) => {
  res.render('pages/admin/profile', {
    title: 'Admin Profile - Accelerator Platform',
    layout: 'admin',
    activeProfile: true,
...
router.get('/profile-settings', requireAdminAuth, (req, res) => {
  res.render('pages/admin/profile-settings', {
    title: 'Profile Settings - Accelerator Platform',
    layout: 'admin',
    activeProfileSettings: true,
    user: res.locals.user,
  });
});
...
router.get('/notifications', requireAdminAuth, (req, res) => {
  res.render('pages/admin/notifications', {
    title: 'Notifications - Accelerator Platform',
    layout: 'admin',
...
router.get('/activity', requireAdminAuth, (req, res) => {
  res.render('pages/admin/activity', {
    title: 'Activity Log - Accelerator Platform',
    layout: 'admin',
    activeActivity: true,
    user: res.locals.user,
  });
...
// GET admin stop impersonating user
router.get(
  '/stop-impersonation',
  requireAdminAuth,
  adminController.stopImpersonateUserPage.bind(adminController)
);
