    ...
    if (isHtmxRequest(req)) {
      const notificationHtml = notifications
        ...
        <tr class="border-b border-input/40 hover:bg-accent/50 transition-colors duration-150">
          ...
          <td class="px-6 py-4">
            <div class="relative">
              <button onclick="toggleActionMenu(this)" data-entity="notification" data-id="${notif.id}" class="p-2 rounded-full hover:bg-accent text-muted-foreground hover:text-accent-foreground transition-colors">
              ...
              <div id="actionMenu-notification-${notif.id}" class="dropdown-menu hidden absolute right-0 mt-2 w-48 bg-card rounded-md shadow-lg z-10 border border-input/80">
                <div class="py-1">
                  <a href="/admin/table-pages/notifications/${notif.id}" class="flex items-center px-4 py-2 text-sm text-foreground hover:bg-accent transition-colors">
                  ...
                  <button onclick="markAsRead(${notif.id})" class="flex items-center w-full px-4 py-2 text-sm text-foreground hover:bg-accent transition-colors">
                  ...
                  <button onclick="editNotification(${notif.id})" class="flex items-center w-full px-4 py-2 text-sm text-foreground hover:bg-accent transition-colors">
                  ...
                  <button onclick="deleteNotification(${notif.id}, '${notif.title}')" class="flex items-center w-full px-4 py-2 text-sm text-destructive hover:bg-destructive/10 transition-colors">
