...
export const getLandingPage = async (req, res) => {
  try {
    ...
    if (search) {
      ...
      filteredSections = sections.filter((section) => {
        return (
          ...
          (section.is_active !== undefined &&
            section.is_active.toString().toLowerCase().includes(searchTerm))
        );
      });
    }
    ...
    res.render('admin/table-pages/landing-page', {
      ...
      currentUrl: '/admin/table-pages/landing-page',
      colspan,
    });
  } catch (error) {
